...
<div>
    ...
    <div class="running">
    <button class="start0" @click="startTimer()" v-show="!active"></button>
    <button class="stop" @click="stopTimer()" v-show="active"></button>
    <a href="http://localhost:8000/start2">
    <button class="end" @click="end()"></button></a>
    </div>
</div>
</template>
