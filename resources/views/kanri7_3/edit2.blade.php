    ...
    <form action="/Kanri7_3/update" method="post">
      ...
      @csrf
         ...
         <tr><th>体重: </th><td><input type="number" step="0.1" name="weight"
            ...
            <tr><th>郵便番号: </th><td><input type="text" name="zip11" size="10" maxlength="8" onKeyUp="AjaxZip3.zip2addr(this,'','addr11','addr11');"value="{{$items->zip11}}" ></td></tr>
         <tr><th>住所: </th><td><input type="text" name="addr11" size="60"value="{{$item->addr11}}"></td></tr>
