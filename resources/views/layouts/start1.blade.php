...
/*ここまで各ボタン */
.start0 { text-align:center;}/*ボタンを中央にする*/
.button1{width:30%;padding:10px;font-size:30px;}/*ボタンのサイズ変更*/
a.btn-radius-solid {
  background: #f1e767;
  background: -webkit-gradient(linear, left top, left bottom, from(#f1e767), to(#feb645));
  background: -webkit-linear-gradient(top, #f1e767 5%, #feb645 100%);
  background: linear-gradient(to bottom, #f1e767 0%, #feb645 100%);
}/*ボタンを押したときのアニメーション*/

a.btn-radius-solid:hover {
  background: -webkit-gradient(linear, left bottom, left top, from(#f1e767), to(#feb645));
  background: -webkit-linear-gradient(bottom, #f1e767 50%, #feb645 100%);
  background: linear-gradient(to top, #f1e767 50%, #feb645 100%);
}/*ボタンを押したときのアニメーション*/
</style>
</head>
